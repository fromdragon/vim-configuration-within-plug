...
hi CursorLineNr    term=bold cterm=bold ctermfg=130 ctermbg=234 gui=bold guifg=Brown
...
hi Comment         term=bold ctermfg=110 ctermbg=234 guifg=Blue
hi Constant        term=underline ctermfg=124 ctermbg=234 guifg=Magenta
