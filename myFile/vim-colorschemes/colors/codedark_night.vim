...
let g:colors_name="codedark_night"
...
let s:cdNight = {'gui': '#1E1E1E', 'cterm': s:cterm00, 'cterm256': '235'}
...
call <sid>hi('Normal', s:cdFront, s:cdNight, 'none', {})
...
call <sid>hi('Error', s:cdOrange, s:cdGray, 'undercurl', s:cdRed)
